...
def consolidate(
    ...
    # Save tokenizers.
    gen_tokenizer = BertTokenizerFast.from_pretrained(generator_tokenizer_name_or_path)
    gen_tokenizer.save_pretrained(dest_dir / "generator_tokenizer/")
    question_encoder_tokenizer = BertTokenizerFast.from_pretrained(question_encoder_tokenizer_name_or_path)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--generator_name_or_path", default='rag_ckpt/rag_generator/albert2albert', type=str, help="Generator model identifier")
    parser.add_argument(
        "--question_encoder_name_or_path", default='ckiplab/albert-base-chinese', type=str, help="Question encoder model identifier"
    )
